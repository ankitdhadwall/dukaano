...
export const hi = {
  ...
  'errors.sale.emptyCart': 'बिल में कम से कम एक चीज़ डालें।',
  'errors.sale.quantityRequired': 'मात्रा डालें।',
  'errors.sale.overpaid': 'पेमेंट बिल से ज़्यादा है। बाकी पैसे लौटा दें, या एडवांस के तौर पर दर्ज करें।',
  'errors.sale.creditLimitExceeded': 'इससे {{name}} की उधार की सीमा पार हो जाएगी। फिर भी आगे बढ़ें?',
  'errors.sale.cancelReasonRequired': 'बताएं कि यह बिल क्यों रद्द किया जा रहा है।',
  'errors.sale.alreadyCancelled': 'यह बिल पहले ही रद्द हो चुका है।',
  'errors.sale.hasReturns': 'इस बिल पर पहले से वापसी दर्ज है। पहले उसे देखें।',
  'errors.sale.emptyReturn': 'वापस करने के लिए कम से कम एक चीज़ चुनें।',
  'errors.sale.invalidItemId': 'यह चीज़ इस बिल में नहीं है।',
  'errors.sale.returnExceedsSold': 'इस चीज़ की सिर्फ़ {{returnable}} ही वापस हो सकती है।',
  'errors.sale.refundExceedsPaid': 'ज़्यादा से ज़्यादा {{max}} नकद लौटा सकते हैं — बाकी उधार था, वो खाते से कट जाएगा।',
  'errors.payment.invalidMethod': 'चुनें कि पैसे कैसे मिले।',
  'errors.payment.amountRequired': 'रकम डालें।',
  'errors.payment.alreadyReversed': 'यह पेमेंट पहले ही वापस हो चुका है।',
  'errors.payment.notReversible': 'सिर्फ़ मिले हुए पैसे वापस किए जा सकते हैं।',
  'errors.payment.reversalReasonRequired': 'बताएं कि यह पेमेंट क्यों वापस किया जा रहा है।',
  'errors.payment.overAllocated': 'चुने हुए बिल पेमेंट से ज़्यादा के हैं।',
  'errors.customer.nameRequired': 'ग्राहक का नाम डालें।',
  'errors.customer.invalidId': 'यह ग्राहक नहीं मिला।',
  'errors.khata.reasonRequired': 'सुधार के लिए वजह ज़रूरी है। यह खाते में हमेशा दिखेगी।',
  'errors.khata.invalidAdjustment': 'सही तरह का सुधार चुनें।',

  // --- billing ---------------------------------------------------------------------------------
  'sale.udhaar': 'उधार',
  'sale.cash': 'नकद',
  'sale.split': 'आधा-आधा',
  'sale.change': 'वापस {{amount}}',
  'sale.saved': 'बिल सेव हो गया',
  'sale.cancelled': 'बिल रद्द हो गया',
  'sale.stockWentNegative': '{{product}} का स्टॉक अब शून्य से नीचे है। गिनती ठीक करने के लिए दबाएं।',
  'khata.outstanding': 'बकाया {{amount}}',
  'khata.advance': '{{amount}} जमा',
  'khata.settled': 'पूरा हिसाब हो गया',
  'khata.paymentReceived': '{{amount}} मिले',
  'khata.statement': 'खाते का हिसाब',
  'khata.ageing.current': 'इस हफ़्ते',
  'khata.ageing.week2': '15 दिन तक',
  'khata.ageing.month1': 'एक महीने तक',
  'khata.ageing.older': 'एक महीने से ऊपर',
